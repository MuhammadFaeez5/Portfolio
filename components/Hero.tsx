...
const Hero: React.FC = () => {
  ...
  const roles = ['AI Engineer', 'Full Stack Dev'];
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden bg-charcoal">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] pointer-events-none select-none">
        <h1 className="text-[32vw] font-black tracking-tighter leading-none text-white">FAEEZ</h1>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-12">
            <div className="reveal-left inline-flex items-center gap-4 px-4 py-2 rounded-full bg-white/5 border border-white/10 soft-shadow">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Muhammad Faeez Portfolio 2026</span>
            </div>

            <div className="reveal-left">
              <h2 className="text-[9vw] lg:text-[5.5vw] font-black leading-[0.85] tracking-tighter text-white mb-8">
                Turning Ideas Into <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-violet">AI-Driven Products</span>.
              </h2>
            </div>
            ...
            Building AI-powered applications and scalable web systems. Focused on solving real-world problems using intelligent solutions. Open to full-time opportunities.  
            </p>
          ...
          <div className="lg:col-span-5 relative reveal scale-up hidden lg:block">
            <div className="relative z-10 aspect-[5/5] rounded-[3rem] overflow-hidden border border-white/10 group shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 right-8 p-8 glass rounded-3xl">
                 ...
                 <div className="text-lg font-bold text-white">AI Applications & Full-Stack Development</div>
              </div>
            </div>
          </div>
        </div>
